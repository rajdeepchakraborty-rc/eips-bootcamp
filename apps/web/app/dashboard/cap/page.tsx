  ...
  return (
    <DashboardShell>
      <div className="space-y-5">
        <div
          className="relative overflow-hidden rounded-3xl border border-border px-6 pt-8 pb-10"
          style={{
            background:
        ...
        <div className="rounded-3xl border border-border bg-background/20 px-6 py-10">
