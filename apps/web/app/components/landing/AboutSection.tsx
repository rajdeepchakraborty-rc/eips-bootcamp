      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed text-left md:text-center">
            EIPsInsight Bootcamp is an initiative dedicated to opening the doors of Ethereum protocol development and governance. We believe that understanding Ethereum Improvement Proposals (EIPs) shouldn't be restricted to a select few.
          </p>
