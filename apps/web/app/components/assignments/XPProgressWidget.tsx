    ...
    <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/5 border border-cyan-500/20 rounded-2xl p-6 hover:border-cyan-500/40 transition-colors">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-bold text-foreground">XP Progress</h3>
        </div>
      ...
      {/* Level */}
      <div className="mb-4 p-4 bg-background/30 border border-cyan-500/20 rounded-lg">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="text-center">
          <div className="text-sm font-bold text-foreground">{stats.totalXpEarned}</div>
        ...
        <div className="text-center">
          ...
          <div className="text-xs text-muted-foreground">To Level {level + 1}</div>
        </div>
      </div>
    </div>
  );
