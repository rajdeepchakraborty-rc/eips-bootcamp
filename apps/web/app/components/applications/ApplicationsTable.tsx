...
export function ApplicationsTable({ applications, loading, onStatusChange }: ApplicationsTableProps) {
  ...
  return (
    <>
      {/* Table Container */}
      <div className="rounded-xl border border-zinc-200 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-sm overflow-hidden hover:border-white/20 transition-all duration-300">
        {/* Table Header */}
        <div className="overflow-x-auto">
          <table className="w-full">
            {/* Header Row */}
            <thead>
              <tr className="border-b border-zinc-200 dark:border-white/10 bg-white/80 dark:bg-black/40">
