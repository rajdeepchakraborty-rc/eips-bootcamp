...
export function ModuleDetail({ module, onBack, lessons, onLessonComplete }: ModuleDetailProps) {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <div className="w-96 bg-gradient-to-b from-gray-50 via-white to-white dark:from-gray-950 dark:via-black dark:to-black border-r border-gray-200 dark:border-gray-800 flex flex-col overflow-hidden">
        {/* Module Header */}
        <div className="p-6 border-b border-gray-200 dark:border-gray-800">
          <button
            onClick={onBack}
            className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-emerald-400 transition-colors mb-4"
          >
            <ChevronLeft size={18} />
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h2 className="text-lg font-bold text-zinc-900 dark:text-white mt-1">{module.title}</h2>
            </div>
          </div>
        </div>
            ...
            <button
              ...
              className={`w-full text-left p-4 rounded-xl transition-all ${
                selectedLesson === lesson.id
                  ...
                  : 'bg-gray-100 hover:bg-gray-200/80 dark:bg-gray-800/30 dark:hover:bg-gray-800/50 border border-zinc-200 dark:border-gray-700/50'
              }`}
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h4 className="text-sm font-semibold text-zinc-900 dark:text-white mt-1 line-clamp-2">
                    {lesson.title}
                  </h4>
        ...
        {/* Module Stats */}
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 space-y-3 bg-gradient-to-t from-white dark:from-black to-transparent">
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl">{module.description}</p>
      </div>

      {/* Key Takeaways */}
      <div className="bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 rounded-2xl p-8 mb-12">
        <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">What You'll Learn</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {lessons.map((lesson, idx) => (
            <div key={lesson.id} className="flex gap-4">
              ...
              <div>
                <h3 className="text-zinc-900 dark:text-white font-semibold mb-1">{lesson.title}</h3>
    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="mb-12">
        <div className="flex items-start justify-between mb-4">
          <h1 className="text-5xl font-bold text-zinc-900 dark:text-white flex-1">{lesson.title}</h1>
          {lesson.completed && (
      ...
      <div className="space-y-12">
        ...
        {(() => {
          ...
          if (videoUrl.includes('youtube.com/watch?v=')) {
            ...
            return (
              <div className="w-full aspect-video rounded-2xl overflow-hidden border border-zinc-200 dark:border-white/10 shadow-2xl bg-white dark:bg-black">
                <video 
                  src={videoUrl}
                  controls
          ...
          if (embedUrl) {
            ...
            return (
              <div className="bg-gradient-to-br from-gray-900/50 to-black/50 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 flex flex-col items-center justify-center min-h-64">
                <PlayCircle size={64} className="text-emerald-400/30 mb-4" />
                <p className="text-gray-600 dark:text-gray-400 text-center">No video available for this lesson</p>
              </div>
            );
          }
        })()}
        ...
        <div className="bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 rounded-2xl p-8">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">Key Points</h2>
        ...
        {/* Resources */}
        <div>
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">Resources</h2>
          <div className="space-y-3">
            {[
              ...
              <button
                key={idx}
                className="w-full flex items-center gap-3 p-4 bg-gray-100 dark:bg-gray-800/30 hover:bg-gray-800/50 border border-gray-700/50 hover:border-emerald-500/30 rounded-xl transition-all text-left"
              >
                <resource.icon size={20} className="text-emerald-400 flex-shrink-0" />
                <span className="font-medium text-zinc-900 dark:text-white flex-1">{resource.title}</span>
        ...
        {!lesson.completed && (
          <div className="flex gap-4 pt-8 border-t border-gray-200 dark:border-gray-800">
            ...
            <button 
              ...
              className="px-6 py-4 bg-gray-200/50 dark:bg-gray-800/50 hover:bg-gray-800 border border-gray-200 dark:border-gray-700 text-zinc-900 dark:text-white font-semibold rounded-xl transition-all flex items-center gap-2"
            >
              <Clock size={18} />
              Save Progress
            </button>
