  ...
  return (
    <div className="relative w-40 h-40 mx-auto mb-6">
      ...
      <div className="absolute inset-0 flex items-center justify-center flex-col">
        <p className="text-foreground font-bold text-2xl">{total}</p>
        <p className="text-muted-foreground text-xs">Total Apps</p>
      </div>
    </div>
  );
}
    ...
    <div className="rounded-xl border border-emerald-500/20 bg-background/40 backdrop-blur-xl overflow-hidden shadow-lg shadow-emerald-500/10 p-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-foreground font-semibold text-sm">{data.approved}</span>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-foreground font-semibold text-sm">{data.pending}</span>
            <span className="text-muted-foreground text-xs">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-foreground font-semibold text-sm">{data.rejected}</span>
            <span className="text-muted-foreground text-xs">
