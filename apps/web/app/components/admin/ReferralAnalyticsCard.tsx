    ...
    <div className="rounded-xl border border-emerald-500/20 bg-background/40 backdrop-blur-xl overflow-hidden shadow-lg shadow-emerald-500/10 p-6">
      ...
      <div className="space-y-5">
        ...
        <div className="rounded-lg bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 p-4">
          <div className="flex items-center justify-between mb-2">
            <p className="text-muted-foreground text-sm font-medium">XP Generated</p>
      ...
      <div className="mt-6 pt-6 border-t border-emerald-500/10">
        <div className="grid grid-cols-3 gap-3 text-center">
          <div>
            <p className="text-muted-foreground text-xs mb-1">Avg. Reward</p>
            <p className="text-emerald-400 font-semibold text-sm">
              {(data.xpGenerated / data.totalReferrals).toFixed(0)} XP
            </p>
          </div>
          <div>
            <p className="text-muted-foreground text-xs mb-1">Active Rate</p>
            <p className="text-emerald-400 font-semibold text-sm">92%</p>
          </div>
          <div>
            <p className="text-muted-foreground text-xs mb-1">Avg. Join Time</p>
